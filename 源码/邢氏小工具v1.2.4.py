...
def games():
      ...
      def bird():
        subprocess.Popen("flybird//bird.exe")
...
def xiangji():
      subprocess.Popen("camera//amcap.exe")
...
def laji():
      ...
      def laji2():
            subprocess.Popen("exe//clean.exe")
...
def mu():
    ...
    root1.resizable(False, False)#固定窗体
    root1.config(background="#6fb739")
    root1.iconbitmap('k.ico')
    pygame.init()
    def sousuo():
            ...
            if result[0]:
                ...
                if 'html' not in str(file):
                    ...
                    try:
                        ...
                        tk.messagebox.showinfo(title = '提示',message='请重试！')
                else:
        ...
        if __name__ == '__main__':
            main()
            lyric = get_lyric(music_id)
            root2 = tk.Toplevel(root1)  #设置窗口
            root2.title('邢氏音乐 歌词')
            sb = Scrollbar(root2)  #设置窗口滚动条
            sb.pack(side = RIGHT, fill = Y)  #设置窗口滚动条位置
            
            mylist = Listbox(root2, yscrollcommand = sb.set,width=120,height=40)  #创建列表框
            
            a=lyric.split('\n')
            for i in a:
                mylist.insert(END,i)   #设置范围
            
            mylist.pack( side = LEFT )  
            sb.config( command = mylist.yview ) 

            t1 = tkinter.Label(root1, text=imfortion,background="#6fb739")
            t1.pack()
            t1.place(x=25, y=65)
    ...
    def ran():
        yinyue = ['http://music.163.com/song/media/outer/url?id=36990266.mp3', 'http://m10.music.126.net/20220729093654/f10912cf255f0f643d4dc27fdf116107/ymusic/cd83/7084/b9e6/381d04785de4b1984543f24bdfdad802.mp3', 'http://m10.music.126.net/20220729094007/7c32007dff22919165ec9fe5dbcaae29/ymusic/ffdb/183c/8bf3/46ede7216e3c6f14404da66d8da02b27.mp3', 'http://m701.music.126.net/20220729100417/dbf9e39c82f34b0a18c0048c4cf1ea43/jdymusic/obj/wo3DlMOGwrbDjj7DisKw/14096431035/6899/efc1/4dc9/8f476229e0759cfda5e2c6c7d18c58da.mp3', 'http://music.163.com/song/media/outer/url?id=1901371647.mp3', 'http://music.163.com/song/media/outer/url?id=1958357679.mp3', 'http://music.163.com/song/media/outer/url?id=1815085049.mp3', 'http://music.163.com/song/media/outer/url?id=1804320463.mp3', 'http://music.163.com/song/media/outer/url?id=1892668095.mp3', 'http://music.163.com/song/media/outer/url?id=1967457117.mp3', 'http://music.163.com/song/media/outer/url?id=1965648349.mp3', 'http://music.163.com/song/media/outer/url?id=5143048285.mp3', 'http://music.163.com/song/media/outer/url?id=1824045033.mp3', 'http://music.163.com/song/media/outer/url?id=1934251776.mp3', 'http://music.163.com/song/media/outer/url?id=1922888354.mp3', 'http://music.163.com/song/media/outer/url?id=1959667345.mp3', 'http://music.163.com/song/media/outer/url?id=475479888.mp3', 'http://music.163.com/song/media/outer/url?id=1403318151.mp3', 'http://music.163.com/song/media/outer/url?id=488249475.mp3', 'http://music.163.com/song/media/outer/url?id=1901371647.mp3', 'http://music.163.com/song/media/outer/url?id=1964443044.mp3', 'http://music.163.com/song/media/outer/url?id=1807799505.mp3', 'http://music.163.com/song/media/outer/url?id=30612793.mp3', 'http://music.163.com/song/media/outer/url?id=1907766514.mp3', 'http://music.163.com/song/media/outer/url?id=1372188635.mp3', 'http://music.163.com/song/media/outer/url?id=1410647903.mp3', 'http://music.163.com/song/media/outer/url?id=1827600686.mp3', 'http://music.163.com/song/
/media/outer/url?id=1940334604.mp3', 'http://music.163.com/song/media/outer/url?id=400876320.mp3', 'http://music.163.com/song/media/outer/url?id=1915796767.mp3', 'http://music.163.com/song/media/outer/url?id=28718313.mp3', 'http://music.163.com/song/media/outer/url?id=1824020871.mp3', 'http://music.163.com/song/media/outer/url?id=30431367.mp3', 'http://music.163.com/song/media/outer/url?id=1398508295.mp3', 'http://music.163.com/song/media/outer/url?id=1968156159.mp3', 'http://music.163.com/song/media/outer/url?id=1456673752.mp3', 'http://music.163.com/song/media/outer/url?id=1964850580.mp3', 'http://music.163.com/song/media/outer/url?id=1804879213.mp3', 'http://music.163.com/song/media/outer/url?id=864498975.mp3', 'http://music.163.com/song/media/outer/url?id=1826189041.mp3', 'http://music.163.com/song/media/outer/url?id=1407551413.mp3', 'http://music.163.com/song/media/outer/url?id=518686034.mp3', 'http://music.163.com/song/media/outer/url?id=1391891631.mp3', 'http://music.163.com/song/media/outer/url?id=1953125353.mp3', 'http://music.163.com/song/media/outer/url?id=442867526.mp3', 'http://music.163.com/song/media/outer/url?id=411214279.mp3', 'http://music.163.com/song/media/outer/url?id=1297802566.mp3', 'http://music.163.com/song/media/outer/url?id=32431987.mp3', 'http://music.163.com/song/media/outer/url?id=1486264538.mp3', 'http://music.163.com/song/media/outer/url?id=1961735531.mp3', 'http://music.163.com/song/media/outer/url?id=362998.mp3', 'http://music.163.com/song/media/outer/url?id=298258.mp3', 'http://music.163.com/song/media/outer/url?id=1882716480.mp3']
        headers = {
                    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) '
                                'Chrome/101.0.4951.41 Safari/537.36 Edg/101.0.1210.32'}
        file = requests.get(url=random.choice(yinyue), headers=headers).content
        try:
            with open(f'a.mp3', 'wb') as f:
                f.write(file)
                f.close()
            ...
            tk.messagebox.showinfo(title = '提示',message='请赐予小工具足够的权限进行音乐文件的读写')
    ...
    b6 = tkinter.Button(root1, text='随机一首',command=ran,width=10, height=1)
    b6.pack()
    b6.place(x=280, y=350)
...
root.iconbitmap('ico//k.ico')#设置图片

def st_(event):
    st.place(x=event.x,y=event.y)

def lb_(event):
    lb.place(x=event.x,y=event.y)

def button_1(event):
    button1.place(x=event.x,y=event.y)

def button_2(event):
    button2.place(x=event.x,y=event.y)

def button_3(event):
    button3.place(x=event.x,y=event.y)

def button_4(event):
    button4.place(x=event.x,y=event.y)

def button_5(event):
    button5.place(x=event.x,y=event.y)

def button_6(event):
    button6.place(x=event.x,y=event.y)

def button_7(event):
    button7.place(x=event.x,y=event.y)

def button_8(event):
    button8.place(x=event.x,y=event.y)

def button_9(event):
    button9.place(x=event.x,y=event.y)

def button_10(event):
    button10.place(x=event.x,y=event.y)

def button_11(event):
    button11.place(x=event.x,y=event.y)

def button_12(event):
    button12.place(x=event.x,y=event.y)

def button_13(event):
    button13.place(x=event.x,y=event.y)

def button_14(event):
    button14.place(x=event.x,y=event.y)

def button_15(event):
    button15.place(x=event.x,y=event.y)

def button_16(event):
    button16.place(x=event.x,y=event.y)

def button_17(event):
    button17.place(x=event.x,y=event.y)

def button_18(event):
    button18.place(x=event.x,y=event.y)

def button_19(event):
    button19.place(x=event.x,y=event.y)
